...
<div>
    ...
    <ul>
        ...
        <br>
        <div>
            <a href="https://github.com/ShaharAshe/LeetCode/tree/main/leetcode-73-Set_Matrix_Zeroes" alt="73 - Set Matrix Zeroes">
                <li> 73 - Set Matrix Zeroes </li>
            </a>
            <ul>
                <a href="https://github.com/ShaharAshe/LeetCode/blob/main/leetcode-73-Set_Matrix_Zeroes/leetcode-73-Set_Matrix_Zeroes-V1.cpp" alt="73 - Set Matrix Zeroes - Cpp - V1">
                    <li> Cpp - V1 </li>
                </a>
                <a href="https://github.com/ShaharAshe/LeetCode/blob/main/leetcode-73-Set_Matrix_Zeroes/leetcode-73-Set_Matrix_Zeroes-V2.cpp" alt="73 - Set Matrix Zeroes - Cpp - V2">
                    <li> Cpp - V2 </li>
                </a>
            </ul>
        </div>
        ...
        <br>
        <div>
            <a href="https://github.com/ShaharAshe/LeetCode/tree/main/leetcode-122-Best_Time_to_Buy_and_Sell_Stock_II" alt="122 - Best Time to Buy and Sell Stock II">
                <li> 122 - Best Time to Buy and Sell Stock II </li>
            </a>
            <ul>
                <a href="https://github.com/ShaharAshe/LeetCode/blob/main/leetcode-122-Best_Time_to_Buy_and_Sell_Stock_II/leetcode-122-Best_Time_to_Buy_and_Sell_Stock_II.cpp" alt="122 - Best Time to Buy and Sell Stock II - cpp">
                    <li> Cpp </li>
                </a>
            </ul>
        </div>
